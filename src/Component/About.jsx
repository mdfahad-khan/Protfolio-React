...
const About = () => {
  return (
    <div
      ...
      <div className="pb-8 mt-[900px] ml-40 md:mt-10">
          <p className="text-4xl font-boll inline border-b-4 border-gray-500">
            About
          </p>
          
        </div>
       <div className="max-w-[1240px] md:my-10 mx-auto p-2 md:grid grid-cols-3">
